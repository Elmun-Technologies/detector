...
| PostgreSQL URL and Alembic schema | EXTERNAL_CREDENTIAL_REQUIRED | `DATABASE_URL=postgresql+psycopg://...`; production startup rejects SQLite. Run `alembic upgrade head` against provisioned PostgreSQL. |
