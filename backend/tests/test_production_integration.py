...
def test_persisted_onboarding_upload_queue_report_metrics_exports_and_deletion():
    ...
    with TestClient(app) as client:
        ...
        upload=client.post(f'/v1/workspaces/{workspace}/videos/upload',data={'context':json.dumps(context())},files={'file':('clip.mp4',b'not-real-video','video/mp4')},headers=auth)
